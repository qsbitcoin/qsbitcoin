...
std::string ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_QUANTUM_SIG_VERIFICATION:
            return "Quantum signature verification failed";
        case SCRIPT_ERR_QUANTUM_WRONG_KEY_TYPE:
            return "Wrong quantum key type for operation";
