...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "estimatequantumfee", 0, "conf_target" },
    { "estimatequantumtxfee", 0, "n_inputs" },
    { "estimatequantumtxfee", 1, "n_outputs" },
    { "estimatequantumtxfee", 3, "conf_target" },
